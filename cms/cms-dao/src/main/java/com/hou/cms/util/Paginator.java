...
public class Paginator {
    ...
    private String getPages(int i, String pages) {
        if (i != page) {
            if (url.contains("?")) {
                return pages.concat("<a href=\"" + url + "&" + param + "=" + i + "\">" + i + "</a>\n");
            } else {
                return pages.concat("<a href=\"" + url + "?" + param + "=" + i + "\">" + i + "</a>\n");
            }
        } else {
            return pages.concat("<span class=\"current\">" + i + "</span>\n");
        }
    }
